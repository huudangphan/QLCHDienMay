...
VALUES('CC001','Toshiba',N'Nhật Bản')
INSERT INTO ThuongHieu(MaNCC,TenThuongHieu,XuatXu)
VALUES('CC002','Samsung',N'Hàn Quốc')
INSERT INTO ThuongHieu(MaNCC,TenThuongHieu,XuatXu)
VALUES('CC003','Panasonic',N'Nhật Bản')
INSERT INTO ThuongHieu(MaNCC,TenThuongHieu,XuatXu)
VALUES('CC004','LG',N'Hàn Quốc')
INSERT INTO ThuongHieu(MaNCC,TenThuongHieu,XuatXu)
VALUES('CC005','DELL',N'US')
INSERT INTO ThuongHieu(MaNCC,TenThuongHieu,XuatXu)
VALUES('CC006','Sony',N'Nhật Bản')
GO
SELECT * FROM ThuongHieu
*/
------KhuyenMai------
INSERT INTO KhuyenMai(TenKM,PhanTramKhuyenMai,NgayBatDau,NgayKetThuc,MoTa)
VALUES(N'Khuyến mãi năm 2021-2022',0.1,'2021-1-1','2021-12-30',N'Khuyến mãi năm 2021')
GO
INSERT INTO KhuyenMai(TenKM,PhanTramKhuyenMai,NgayBatDau,NgayKetThuc,MoTa)
VALUES(N'Khuyến mãi tháng 12',0.2,'2021-12-1','2021-12-30',N'Khuyến mãi 20% tháng 12 2021')
GO
...
VALUES(N'Tủ lạnh Toshiba Inverter 312 lít GR-RT400WE-PMV(06)-MG','TH001',null,12990000,null)
INSERT INTO SanPham(TenSanPham,MaThuongHieu,AnhMinhHoa,DonGia,MaKhuyenMai)
VALUES(N'Tủ lạnh Panasonic Inverter 550 lít NR-DZ600GXVN','TH003',null,37990000,null)
INSERT INTO SanPham(TenSanPham,MaThuongHieu,AnhMinhHoa,DonGia,MaKhuyenMai)
VALUES(N'Tủ lạnh Toshiba Inverter 622 lít GR-RF690WE-PGV','TH001',null,35990000,'KM00000001')
INSERT INTO SanPham(TenSanPham,MaThuongHieu,AnhMinhHoa,DonGia,MaKhuyenMai)
VALUES(N'Tủ mát Panasonic 460 lít SMR-PT450A','TH003',null,16300000,null)
INSERT INTO SanPham(TenSanPham,MaThuongHieu,AnhMinhHoa,DonGia,MaKhuyenMai)
VALUES(N'Laptop Dell Inspiron 7306 i5-1135G7 13.3 inch N3I5202W','TH005',null,27890000,null)
GO
SELECT * FROM SanPham
------ChiTietLoai------
...
INSERT INTO ThongSoKiThuat(MaSanPham,TenThongSo,MoTa)
VALUES('SP00000001',N'Xuất xứ',N'Trung Quốc')
INSERT INTO ThongSoKiThuat(MaSanPham,TenThongSo,MoTa)
...
INSERT INTO ThongSoKiThuat(MaSanPham,TenThongSo,MoTa)
VALUES('SP00000003',N'Xuất xứ',N'Trung Quốc')
INSERT INTO ThongSoKiThuat(MaSanPham,TenThongSo,MoTa)
...
VALUES(N'Vũ Phạm Hoài Nam','2000-10-24','0912452117','hoainam11134@gmail.com',N'20 Đường số 5',0,'CV001','CH001',0,'hoainam11134','123456',0)
INSERT INTO NhanVien(TenNhanVien,NgaySinh,SDT,Email,DiaChi,GioiTinh,ChucVu,CuaHang,HinhThuc,TaiKhoan,MatKhau,TrangThai)
VALUES(N'Nguyễn Văn A','2000-1-4','0911445789','nhanvien1@gmail.com',N'20/34/3 CMT8',0,'CV003','CH001',0,'ketoan1','123456',0)
INSERT INTO NhanVien(TenNhanVien,NgaySinh,SDT,Email,DiaChi,GioiTinh,ChucVu,CuaHang,HinhThuc,TaiKhoan,MatKhau,TrangThai)
VALUES(N'Nguyễn Vũ Bảo Huy','2000-5-12','0919558991','huyvu123@gmail.com',N'25 Tên Lửa',0,'CV006','CH001',0,'huyvu11134','123456',0)
INSERT INTO NhanVien(TenNhanVien,NgaySinh,SDT,Email,DiaChi,GioiTinh,ChucVu,CuaHang,HinhThuc,TaiKhoan,MatKhau,TrangThai)
VALUES(N'Huỳnh Trấn Thành','2000-8-30','0911052111','huynhtranthanh@gmail.com',N'1 ĐBP',0,'CV001','CH002',0,'tranthanh11134','123456',0)
INSERT INTO NhanVien(TenNhanVien,NgaySinh,SDT,Email,DiaChi,GioiTinh,ChucVu,CuaHang,HinhThuc,TaiKhoan,MatKhau,TrangThai)
VALUES(N'Trần Văn B','1998-1-8','0912499117','tranvan123b@gmail.com',N'15 Đường CC1',0,'CV003','CH002',0,'ketoan2','123456',0)
INSERT INTO NhanVien(TenNhanVien,NgaySinh,SDT,Email,DiaChi,GioiTinh,ChucVu,CuaHang,HinhThuc,TaiKhoan,MatKhau,TrangThai)
VALUES(N'Trần Văn C','1996-11-20','0998554123','mrcvippro@gmail.com',N'57/13 Đường CC1',0,'CV006','CH002',0,'truongkho2','123456',0)
...
VALUES('CC001','NV00000002','K0001','2021-10-10 8:00:00')
...
VALUES('HAPPY2021',N'Voucher 2021',0.1,'2021/1/1','2021/12/30',N'Voucher 10% áp dụng năm 2021')

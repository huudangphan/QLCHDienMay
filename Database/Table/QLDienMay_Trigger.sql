...
BEGIN
	...
	BEGIN TRAN
	BEGIN TRY
		INSERT INTO CuaHang(MaCuaHang,DiaChi,CuaHangTruong,NgayThanhLap)
		VALUES(@ID,@DIACHI,@CHTRUONG,@NGAYTHANHLAP)
		COMMIT
	END TRY
	BEGIN CATCH
		ROLLBACK
...
alter TRIGGER TAO_ID_CHO_PHIEU_NHAP ON PhieuNhap INSTEAD OF INSERT 
AS
BEGIN
...
BEGIN
	...
	BEGIN TRAN
	BEGIN TRY
		INSERT INTO KhachHang(MaKhachHang,TenKhachHang,SDT,DiaChi,Email,TaiKhoan,MatKhau,TrangThai)
		VALUES(@ID,@tenKhachHang,@sDT,@diaChi,@email,@taiKhoan,@matKhau,@trangThai)
		COMMIT
	END TRY
	BEGIN CATCH
		ROLLBACK
...
alter TRIGGER TAO_ID_CHO_THE_TICH_DIEM ON TheTichDiem INSTEAD OF INSERT 
AS
BEGIN
